...
const Navbar = () => {
  ...
  return (
    <nav className="bg-background/95 backdrop-blur-md px-4 md:px-8 py-1 flex justify-between items-center border-b-2 border-primary sticky top-0 z-[1000] flex-wrap gap-3">
      <Link to="/" className="flex items-center gap-3">
        <img
          src={carLiftLogo}
          alt="Car Lift"
          className="h-28 md:h-32 w-auto object-contain drop-shadow-[0_0_12px_hsl(var(--primary)/0.8)]"
        />
      </Link>
